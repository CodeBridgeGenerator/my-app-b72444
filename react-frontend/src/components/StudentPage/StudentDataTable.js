...
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.college}</p>
...
<Column field="college" header="College" body={pTemplate1} filter={selectedFilterFields.includes("college")} hidden={selectedHideFields?.includes("college")}  sortable style={{ minWidth: "8rem" }} />
